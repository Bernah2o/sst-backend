"""make_disability_or_charged_days_nullable

Revision ID: 162f680b5a53
Revises: b70a6d1fef41
Create Date: 2025-08-27 20:42:49.872235
...
revision = '162f680b5a53'
down_revision = 'b70a6d1fef41'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.alter_column('absenteeism', 'disability_or_charged_days',
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('workers', sa.Column('cedula', sa.VARCHAR(length=50), autoincrement=False, nullable=True))

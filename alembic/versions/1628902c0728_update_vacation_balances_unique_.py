...
def upgrade() -> None:
    # Eliminar constraint único compuesto si existe
    op.drop_constraint(
    ...
    # Crear índices NO únicos para mejorar consultas
    op.create_index(
        'ix_vacation_balances_worker_id_nonunique',
        'vacation_balances',
        ['worker_id'],
        unique=False
    )
    op.create_index(
        'ix_vacation_balances_year_nonunique',
        'vacation_balances',
        ['year'],
        unique=False
    )

"""add programa field to occupational_exam and fecha_de_retiro to worker

Revision ID: ec0717042d05
Revises: dc510ede4b09
Create Date: 2025-08-12 21:16:01.645643
...
revision = 'ec0717042d05'
down_revision = 'dc510ede4b09'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('occupational_exams', sa.Column('programa', sa.String(length=200), nullable=True))
    op.add_column('workers', sa.Column('fecha_de_retiro', sa.Date(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('workers', 'fecha_de_retiro')
    op.drop_column('occupational_exams', 'programa')

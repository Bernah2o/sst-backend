"""add_work_modality_to_worker

Revision ID: 909947a78069
Revises: c943857419b2
Create Date: 2025-08-11 11:53:59.637248
...
revision = '909947a78069'
down_revision = 'c943857419b2'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.add_column('workers', sa.Column('work_modality', sa.Enum('ON_SITE', 'REMOTE', 'TELEWORK', 'HOME_OFFICE', 'MOBILE', name='workmodality'), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('workers', 'work_modality')
